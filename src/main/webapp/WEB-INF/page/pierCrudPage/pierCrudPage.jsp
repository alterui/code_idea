    ...
    <script type="text/javascript">
        ...
        function deleteData(id) {
            layer.confirm('真的要删除吗？',function (index) {
                window.location.href = "${pageContext.request.contextPath}/page/pier/delete/" + id;
            })
        }
                        ...
                        layer.confirm('真的删除这'+data.length+'行吗？', function(index){
                            $.ajax({
                                ...
                                success:function (res) {
                                    ...
                                    if(res.length==0){
                                        window.location.href = "${pageContext.request.contextPath}/page/pier/show/";
                                    }else{
                                        layer.msg('删除失败');
                                    }
                                },
        ...
        function getPierSearch(){
            ...
            window.location.href = "${pageContext.request.contextPath}/page/pier/getSearch?start=" + start + " &end=" + end + "";
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                当前位置&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;<a href="/page/pier/show"><font color="#228b22">墩台质量数据</font></a>
            </blockquote>
            ...
            <!-- 搜索框 -->
             <div class="layui-tab" >
                <form action="/page/pier/search" method="post">
                    ...
                    <input type="text" name="search"  style="margin-right: 6px; float: right " required placeholder="请输入结构编号搜索" class="layui-input">
                </form>
             </div>
