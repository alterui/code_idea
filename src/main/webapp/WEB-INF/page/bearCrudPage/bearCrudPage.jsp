...
<head>
    ...
    <script type="text/javascript">
                        ...
                        layer.confirm('真的删除这'+data.length+'行吗？', function(index){
                            $.ajax({
                                ...
                                success:function (res) {
                                    ...
                                    if(res.length==0){
                                        window.location.href = "${pageContext.request.contextPath}/page/bear/show/";
                                    }else{
                                        layer.msg('删除失败');
                                    }
                                },
        ...
        function getBearSearch(){
            ...
            window.location.href = "${pageContext.request.contextPath}/page/bear/getSearch?start=" + start + " &end=" + end + "";
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="demoTable">
                ...
                <a href="/page/bear/addData" class="layui-btn layui-btn-mini">增加数据</a>
