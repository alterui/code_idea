    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                当前位置&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a href="/page/apply/show">报审表和审批表数据</a>&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a><cite>添加报审表和审批表</cite></a>
            </blockquote>
                ...
                <div class="layui-tab layui-tab-card">
                    <form action="/page/apply/add" method="post"  >
                        ...
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>
                                    <input name="contractorUnit" type="textarea" style="width: 150px" required>
                                </td>
                                <td>
                                    <input name="bidNum" type="textarea" required
                                           style="width: 150px">
                                </td>

                                <td>
                                    <input name="supervision" type="textarea" required
                                           style="width: 150px">
                                </td>

                                <td>
                                    <input name="serialNum" type="textarea" required
                                           style="width: 150px">
                                ...
                                <td>
                                    <input name="director" type="textarea" required
                                           style="width: 150px">

                                </td>

                                <td>
                                    <input name="projectName" type="textarea" required
                                           style="width: 150px">
