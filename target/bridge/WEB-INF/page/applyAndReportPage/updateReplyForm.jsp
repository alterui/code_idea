<%--
  Created by IntelliJ IDEA.工程总监修改回复内容
  User: ALTERUI
  Date: 2019/3/25
  Time: 15:57
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                当前位置&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;<a><font color="#228b22">回执单修改意见</font></a>
            </blockquote>

            <div class="layui-tab">
                <form action="/page/apply/hasReplyFrom" method="post" >
                ...
                <span id="print">
                     ...
                     <table  class="layui-table" style="width: 600px;" >
                         ...
                         <tr style="height: 200px">
                             <td colspan="4">
                                 ...
                                 <textarea name="centerView" required lay-verify="required" placeholder="请输入审核意见" class="layui-textarea">${apply.centerView}</textarea>
                 ...
                 <div align="center">
                     ...
                     <a href="/page/apply/showHasCheck"  class="layui-btn layui-btn-danger layui-btn-mini">关闭</a>
