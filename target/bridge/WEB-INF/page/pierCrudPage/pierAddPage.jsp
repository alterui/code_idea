    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                当前位置&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a href="/page/pier/show">墩台验收数据</a>&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a><cite>添加墩台质量数据</cite></a>
            </blockquote>
            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab layui-tab-card">
                    <form action="/page/pier/add" method="post"  class="layui-form">
                        ...
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="length" type="textarea" required
                                           style="width: 60px">
                                </td>

                                <td>
                                    <input name="width" type="textarea" required
                                           style="width: 60px">
                                </td>

                                <td>
                                    <input name="topElev" type="textarea" required
                                           style="width: 60px">

                                </td>

                                <td>
                                    <input name="axisOffs" type="textarea" required
                                           style="width: 60px">
                                ...
                                <td>
                                    <input name="surfVert" type="textarea" required
                                           style="width: 60px">

                                </td>

                                <td>
                                    <input name="planeness" type="textarea" required
                                           style="width: 60px">

                                </td>
                                <td>
                                    <input name="inteFaultTable" type="textarea" required
                                           style="width: 60px">
