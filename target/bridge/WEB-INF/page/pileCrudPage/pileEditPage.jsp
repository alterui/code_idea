    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                当前位置&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a href="/page/pile/show">桩质量验收数据</a>&nbsp;&nbsp;<b>|</b>&nbsp;&nbsp;
                <a><cite>修改桩质量数据</cite></a>
            </blockquote>
            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab layui-tab-card">
                    <form action="/page/pile/update" method="post">
                        ...
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input name="struId" type="textarea" value="${pile.struId}" style="width: 70px" required>
