    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="demoTable">
                ...
                <a href="/page/bear/addData" class="layui-btn layui-btn-mini"><i class="layui-icon">&#xe61f;</i>增加数据</a>
                ...
                <button  onclick="return getBearSearch()"  class="layui-btn layui-btn-mini" type="submit"><i class="layui-icon">&#xe615;</i>查询</button>
